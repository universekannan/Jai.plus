            ...
            <div class="row">
                <div class="col-xl-6 col-lg-7 col-md-9 mx-auto">
                    <div class="section-title text-center mb-55">
                        ...
                        <p class="text-white wow fadeInUp" data-wow-delay=".6s">Lorem ipsum dolor sit amet, consetetur
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="countdown-content-wrapper">
                        ...
                        <div class="countdown-content">
                            ...
                            <p class="text-white mb-30 wow fadeInUp" data-wow-delay=".4s">Lorem ipsum dolor sit amet,
                                consetetur sadipscing elitr, sed dianonumy eirmod tempor invidunt. Lorem ipsum dolor sit
    ...
    (function() {
        function c() {
            ...
            if (b) {
                ...
                d.innerHTML =
                    "window.__CF$cv$params={r:'97cda3dbe9e67ef9',t:'MTc1NzQ5MzgzMQ=='};var a=document.createElement('script');a.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/f78657f80e4b/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";

...
<section class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         ...
         <div class="col-sm-6">
            @if((Auth::user()->usertype_id == 2) || (Auth::user()->usertype_id == 4) || (Auth::user()->usertype_id == 1) )
                        ...
                        <tr>
                           ...
                           <td>
                              <a class="btn btn-success"
                                 href="{{ url('admin/backup/download/'.substr($backup['file_name'],6)) }}"><i
                                 class="fa fa-cloud-download"></i> Download</a>
                              <a class="btn btn-danger" onclick="return confirm('Do you really want to delete this file')" data-button-type="delete"
                                 href="{{ url('admin/backup/delete/'. substr($backup['file_name'],6)) }}"><i class="fa fa-trash-o"></i>
                              Delete</a>
                           </td>
                        </tr>
                        @endforeach

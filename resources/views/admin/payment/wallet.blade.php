...
<section class="content">
    <div class="container-fluid">
        ...
        @endif
        <!-- Withdrawal Modal -->
        <div class="modal fade" id="addwithdrawal" tabindex="-1" role="dialog" aria-labelledby="addWithdrawalLabel"
            aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input required type="number" class="form-control" name="withdrawal_amount"
                                        id="withdrawal_amount" placeholder="Enter amount">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="new_balance" class="col-sm-4 col-form-label">Balance After
                                    Withdrawal</label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" name="new_balance" id="new_balance"
                                        readonly>
                                </div>
                            </div>
                            <div class="form-group row">

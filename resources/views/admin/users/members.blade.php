                                    ...
                                    @foreach($members as $key => $member)
                                        ...
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap">
                                                ...
                                                <a href="{{ url('admin/geneology?r=') }}{{ $member->id }}" class="btn btn-success btn-sm">
                                                ...
                                                @if(auth()->user()->user_type_id == 1)
                                                    ...
                                                    <a href="{{ url('admin/manual_activation') }}/{{ $member->id }}" class="btn btn-warning btn-sm">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div class="mb-3">
                    <img src="" id="member_photo" alt="Member Photo" class="rounded-circle" width="120" height="120" style="object-fit: cover;">
                </div>
                <table class="table table-bordered table-striped">
                    <tbody>
                        <tr><th width="30%">Name</th><td id="view_name"></td></tr>
                        <tr><th>User Name</th><td id="view_user_name"></td></tr>
                        <tr><th>Password</th><td id="view_cpassword"></td></tr>
                        <tr><th>Email</th><td id="view_email"></td></tr>
                        <tr><th>Phone</th><td id="view_phone"></td></tr>
                        <tr><th>Wallet Address</th><td id="view_wallet_address"></td></tr>
                    </tbody>
                </table>
            </div>
        </div>
